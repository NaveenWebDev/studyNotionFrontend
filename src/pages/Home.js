    ...
    <>
                ...
                <div className="min-h-screen">
                    ...
                    <main>
                        <div className='flex justify-center flex-col items-center py-12  gap-6'>
                            ...
                            <h1 className='text-white text-4xl font-semibold'>Empower Your Future with <ColredText >Coding Skills</ColredText></h1>
                            ...
                            <div className="video flex justify-center">
                                <video src={BannerVideo} muted autoPlay width='80%'></video>
                            </div>
                        ...
                        <div className="flex justify-between mt-10">
                            ...
                            <div className="w-[50%] relative flex items-center justify-center">
                                <div className='absolute w-[85%] bg-richblack-800 h-[80%]'>
                                ...
                                <div className="effect absolute bg-[#47bcc03b]  blur-2xl absolute w-[372px] h-[257px] rounded-full top-0 left-0">
                                </div>
        ...
        <section className='py-[5rem]'>
            <div className="max-w-[1200px] w-[90%] m-auto">
                ...
                <div className="flex">
                    <div className="w-[50%] p-5 text-4xl font-semibold">
                ...
                <div className="flex mt-5">
                    ...
                    <div className="w-[60%] relative ">
                        <img src={timelingImg} alt="timelingImg" className='absolute top-0 left-0 w-full h-full object-cover object-center shadow-2xl' />

                        <div className='bg-caribbeangreen-700 absolute w-[70%] m-auto left-[50%] translate-x-[-50%] bottom-[-10%] p-5 flex justify-between'>
                            <div className='flex justify-center border-r border-caribbeangreen-500 items-center w-[50%] gap-5'>
        ...
        <section className='py-[5rem]'>
            <div className="max-w-[1200px] w-[90%] m-auto">
                ...
                <p className='text-center font-medium text-richblack-700 w-[60%] m-auto'>Using spin making learningn multiple language easy with 20+ langauge realistic voice-over, progress tracing, custom schedule and more.</p>

                {/* ==================images====================== */}
              <div className='flex justify-between overflow-hidden relative h-[500px]'>
        ...
        <section className='bg-richblack-900 py-[5rem]'>
            <div className="max-w-[1200px] w-[90%] m-auto">
                <div className="flex">
                    ...
                    <div className="w-[50%] p-5 items-center justify-center flex flex-col lg:items-start">
